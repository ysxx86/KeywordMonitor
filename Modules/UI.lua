...
function UI.CreateConfigFrame()
	...
	local versionText = Utils.CreateFS(versionBtn, 9, "v2.0.4 by 专业打地鼠", false, "RIGHT")
	...
	versionBtn:SetScript("OnClick", function()
		if KM.UI and KM.UI.ShowWelcomeDialog then
			local currentVersion = GetAddOnMetadata("KeywordMonitor", "Version") or "2.0.4"
